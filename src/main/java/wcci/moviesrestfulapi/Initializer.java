...
public class Initializer implements CommandLineRunner {
	...
	private void populateScenes() {
		Scene thor1Scene1 = new Scene(thor1, "Thor scene 1", "https://www.youtube.com/watch?v=JOddp-nlNvQ");
		Scene thor1Scene2 = new Scene(thor1, "Thor scene 2", "https://www.youtube.com/watch?v=JOddp-nlNvQ");
		Scene thor1Scene3 = new Scene(thor1, "Thor scene 3", "https://www.youtube.com/watch?v=JOddp-nlNvQ");
		Scene thor2Scene1 = new Scene(thor2, "Thor: The Dark World scene 1", "https://www.youtube.com/watch?v=npvJ9FTgZbM");
		Scene thor2Scene2 = new Scene(thor2, "Thor: The Dark World scene 2", "https://www.youtube.com/watch?v=npvJ9FTgZbM");
		Scene thor2Scene3 = new Scene(thor2, "Thor: The Dark World scene 3", "https://www.youtube.com/watch?v=npvJ9FTgZbM");
		Scene thor3Scene1 = new Scene(thor3, "Thor: Ragnarok scene 1", "https://www.youtube.com/watch?v=ue80QwXMRHg");
		Scene thor3Scene2 = new Scene(thor3, "Thor: Ragnarok scene 2", "https://www.youtube.com/watch?v=ue80QwXMRHg");
		Scene thor3Scene3 = new Scene(thor3, "Thor: Ragnarok scene 3", "https://www.youtube.com/watch?v=ue80QwXMRHg");
		Scene hangover1Scene1 = new Scene(hangover1, "The Hangover scene 1", "https://www.youtube.com/watch?v=tlize92ffnY");
		Scene hangover1Scene2 = new Scene(hangover1, "The Hangover scene 2", "https://www.youtube.com/watch?v=tlize92ffnY");
		Scene hangover1Scene3 = new Scene(hangover1, "The Hangover scene 3", "https://www.youtube.com/watch?v=tlize92ffnY");
		Scene hangover2Scene1 = new Scene(hangover2, "The Hangover II scene 1", "https://www.youtube.com/watch?v=ohF5ZO_zOYU");
		Scene hangover2Scene2 = new Scene(hangover2, "The Hangover II scene 2", "https://www.youtube.com/watch?v=ohF5ZO_zOYU");
		Scene hangover2Scene3 = new Scene(hangover2, "The Hangover II scene 3", "https://www.youtube.com/watch?v=ohF5ZO_zOYU");
		Scene hangover3Scene1 = new Scene(hangover3, "The Hangover III scene 1", "https://www.youtube.com/watch?v=96TelFMZwHc");
		Scene hangover3Scene2 = new Scene(hangover3, "The Hangover III scene 2", "https://www.youtube.com/watch?v=96TelFMZwHc");
		Scene hangover3Scene3 = new Scene(hangover3, "The Hangover III scene 3", "https://www.youtube.com/watch?v=96TelFMZwHc");
		Scene starScene1 = new Scene(star, "A Star Is Born scene 1", "https://www.youtube.com/watch?v=nSbzyEJ8X9E");
		Scene starScene2 = new Scene(star, "A Star Is Born scene 2", "https://www.youtube.com/watch?v=nSbzyEJ8X9E");
		Scene starScene3 = new Scene(star, "A Star Is Born scene 3", "https://www.youtube.com/watch?v=nSbzyEJ8X9E");
		Scene titanicScene1 = new Scene(titanic, "Titanic scene 1", "https://www.youtube.com/watch?v=zCy5WQ9S4c0");
		Scene titanicScene2 = new Scene(titanic, "Titanic scene 2", "https://www.youtube.com/watch?v=zCy5WQ9S4c0");
		Scene titanicScene3 = new Scene(titanic, "Titanic scene 3", "https://www.youtube.com/watch?v=zCy5WQ9S4c0");
		Scene robotScene1 = new Scene(robot, "I, Robot scene 1", "https://www.youtube.com/watch?v=rL6RRIOZyCM");
		Scene robotScene2 = new Scene(robot, "I, Robot scene 2", "https://www.youtube.com/watch?v=rL6RRIOZyCM");
		Scene robotScene3 = new Scene(robot, "I, Robot scene 3", "https://www.youtube.com/watch?v=rL6RRIOZyCM");
		Scene tarzanScene1 = new Scene(tarzan, "The Legend of Tarzan scene 1", "https://www.youtube.com/watch?v=Aj7ty6sViiU");
		Scene tarzanScene2 = new Scene(tarzan, "The Legend of Tarzan scene 2", "https://www.youtube.com/watch?v=Aj7ty6sViiU");
		Scene tarzanScene3 = new Scene(tarzan, "The Legend of Tarzan scene 3", "https://www.youtube.com/watch?v=Aj7ty6sViiU");
		Scene suicideSquadScene1 = new Scene(suicideSquad, "Suicide Squad scene 1", "https://www.youtube.com/watch?v=CmRih_VtVAs");
		Scene suicideSquadScene2 = new Scene(suicideSquad, "Suicide Squad scene 2", "https://www.youtube.com/watch?v=CmRih_VtVAs");
		Scene suicideSquadScene3 = new Scene(suicideSquad, "Suicide Squad scene 3", "https://www.youtube.com/watch?v=CmRih_VtVAs");
		Scene peterRabbitScene1 = new Scene(peterRabbit, "Peter Rabbit scene 1", "https://www.youtube.com/watch?v=7Pa_Weidt08");
		Scene hungerGames1Scene1 = new Scene(hungerGames1, "The Hunger Games scene 1", "https://www.youtube.com/watch?v=mfmrPu43DF8");
		Scene hungerGames1Scene2 = new Scene(hungerGames1, "The Hunger Games scene 2", "https://www.youtube.com/watch?v=mfmrPu43DF8");
		Scene hungerGames2Scene1 = new Scene(hungerGames2, "The Hunger Games: Catching Fire scene 1", "https://www.youtube.com/watch?v=EAzGXqJSDJ8");
		Scene hungerGames2Scene2 = new Scene(hungerGames2, "The Hunger Games: Catching Fire scene 2", "https://www.youtube.com/watch?v=EAzGXqJSDJ8");
		Scene hungerGames2Scene3 = new Scene(hungerGames2, "The Hunger Games: Catching Fire scene 3", "https://www.youtube.com/watch?v=EAzGXqJSDJ8");
		Scene avengers1Scene1 = new Scene(avengers1, "The Avengers scene 1", "https://www.youtube.com/watch?v=eOrNdBpGMv8");
		Scene avengers1Scene2 = new Scene(avengers1, "The Avengers scene 2", "https://www.youtube.com/watch?v=eOrNdBpGMv8");
		Scene avengers1Scene3 = new Scene(avengers1, "The Avengers scene 3", "https://www.youtube.com/watch?v=eOrNdBpGMv8");
		Scene avengers1Scene4 = new Scene(avengers1, "The Avengers scene 4", "https://www.youtube.com/watch?v=eOrNdBpGMv8");
